...
class Client extends http.BaseClient {
  ...
  Future<http.StreamedResponse> _sendWithRetry(
    ...
    while (true) {
      late http.BaseRequest copiedRequest;
      late LocalSessionState preRequestLocalSessionState;
      late http.StreamedResponse response;

      await _refreshAPILock.synchronized(() async {
  ...
  static Future<UnauthorisedResponse> onUnauthorisedResponse(
    ...
    return await _refreshAPILock.synchronized(() async {
      try {
        ...
        if (postLockLocalSessionState.status !=
            ...
            (postLockLocalSessionState.status ==
                    LocalSessionStateStatus.EXISTS &&
                preRequestLocalSessionState.status ==
                    LocalSessionStateStatus.EXISTS &&
        ...
        refreshReq =
            await Utils.setAuthorizationHeaderIfRequiredForRequestObject(
                refreshReq,
